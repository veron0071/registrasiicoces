...
<head>
    ...
    <title>Payment Verified - ICoCES-2026</title>
</head>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="margin:0 0 20px 0; color:#444444; font-size:15px; line-height:1.6;">
                                We are pleased to inform you that your payment for the <strong>ICoCES-2026</strong> conference has been <strong>successfully verified</strong> by our committee. Your registration is now fully confirmed.
                            </p>

                            <!-- Verification Badge -->
                            <div style="text-align: center; margin-bottom: 24px;">
                                <span style="display:inline-block; background-color:#d4edda; color:#155724; border: 1px solid #c3e6cb; font-size:16px; font-weight:bold; padding:8px 20px; border-radius:30px; letter-spacing: 0.5px;">
                                    ✅ PAYMENT VERIFIED / LUNAS
                                </span>
                            </div>
                                ...
                                <tr>
                                    <td style="padding:20px 24px;">
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="padding:6px 0; color:#777777; font-size:13px; vertical-align:top;">Amount Paid</td>
                                                <td style="padding:6px 0; color:#222222; font-size:14px; font-weight:bold; color:#1f5d3a;">
                            ...
                            <p style="margin:0 0 20px 0; color:#444444; font-size:15px; line-height:1.6;">
                                ...
                                Our team will send out the official invitation letter, scheduling, and zoom link/venue details closer to the conference date. Please save this email as proof of your payment.
                            </p>
                            ...
                            <p style="margin:0; color:#444444; font-size:15px; line-height:1.6;">
                                If you have any further questions, please do not hesitate to contact us by replying to this email.
                            </p>
                        </td>
                    </tr>
