...
@section('content')
    ...
    <div class="relative overflow-hidden -mt-10 mb-10">
        ...
        <div class="absolute top-0 right-0 w-96 h-96 bg-[#d90429]/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3">
        </div>
        <div
            class="absolute bottom-0 left-0 w-72 h-72 bg-[#d90429]/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/4">
        </div>
        ...
        <div class="relative text-center py-12 px-4">
            ...
            <div class="flex justify-center mb-5">
                <div
                    class="w-16 h-16 bg-gradient-to-br from-[#d90429] to-[#a00320] rounded-2xl flex items-center justify-center shadow-lg shadow-[#d90429]/25 rotate-3 hover:rotate-0 transition-transform duration-300">
            ...
            <span
                class="inline-block bg-[#d90429]/10 text-[#d90429] text-[11px] font-bold px-4 py-1.5 rounded-full uppercase tracking-widest mb-4 border border-[#d90429]/15">Open
                Registration</span>
            ...
            <p class="mt-3 text-gray-500 max-w-lg mx-auto text-[15px] leading-relaxed">
                Join the <strong class="text-gray-700">International Conference on Community Engagement for Sustainability
                    2026</strong>. Fill in the form below to secure your spot.
            </p>
        ...
        <div class="w-full max-w-2xl">
            ...
            <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
                <form action="{{ route('registration.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <input type="hidden" name="participant_origin" id="participant_origin"
                        value="{{ old('participant_origin') }}">
                    ...
                    <div class="form-step hidden" data-step="2">
                        <div class="px-4 sm:px-8 pt-8 pb-2">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">Select your participation category and attendance mode
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="px-4 sm:px-8 pb-8 space-y-6">
                                ...
                                <div class="grid grid-cols-2 gap-3" id="category_group">
                                    <button type="button" data-group="category" data-value="presenter"
                                        ...
                                        <div class="text-left min-w-0">
                                            ...
                                            <p class="text-[11px] text-gray-500 mt-0.5 leading-snug">Present a research
                                                paper</p>
                                        </div>
                                        <div class="option-card__check">
                                            <svg class="w-3.5 h-3.5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <button type="button" data-group="category" data-value="non_presenter"
                                        ...
                                        <div class="text-left min-w-0">
                                            ...
                                            <p class="text-[11px] text-gray-500 mt-0.5 leading-snug">Attend as participant
                                            </p>
                                        </div>
                                        <div class="option-card__check">
                                            <svg class="w-3.5 h-3.5 text-white" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div id="fee_container" class="hidden">
                                <div
                                    class="relative bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-4 sm:p-5 text-white overflow-hidden">
                                    {{-- Decorative --}}
                                    <div
                                        class="absolute top-0 right-0 w-32 h-32 bg-[#d90429]/20 rounded-full blur-2xl -translate-y-1/2 translate-x-1/3">
                                    </div>
                                    <div class="relative">
                                        <div class="flex items-center justify-between gap-3">
                                            <div class="min-w-0">
                                                <p class="text-sm font-medium text-gray-400 mb-1">Registration Fee</p>
                                                <p class="text-2xl sm:text-3xl font-extrabold text-white truncate"
                                                    id="fee_amount"></p>
                                            </div>
                                            <div
                                                class="w-11 h-11 sm:w-12 sm:h-12 flex-shrink-0 bg-[#d90429] rounded-xl flex items-center justify-center shadow-lg shadow-[#d90429]/30">
                                        ...
                                        <div class="mt-4 pt-3 border-t border-white/10">
                                            <p class="text-sm text-gray-300">
                                                Transfer to: <strong class="text-white">Bank Rakyat Indonesia (BRI) —
                                                    032501122420506</strong><br>
                                                <span class="text-xs text-gray-400">(a.n. Linda Indiyarti Putri)</span><br>
                                                <span class="text-xs text-gray-400">SWIFT/BIC: BRINIDJAXXX</span><br>
                                                <span class="text-xs text-gray-400">Bank BRI KC Semarang
                                                    Pandanaran</span><br>
                                                <span class="text-xs text-gray-400">Jl. Gajahmada No. 105, Miroto, Kec.
                                                    Semarang Tengah (50135)</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="flex gap-3 pt-3">
                                <button type="button" class="btn-outline-primary flex-1 py-3.5 text-[15px]"
                                    onclick="goToStep(1)">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="form-step hidden" data-step="3">
                        <div class="px-4 sm:px-8 pt-8 pb-2">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">Upload your transfer receipt to complete registration
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="px-4 sm:px-8 pb-8 space-y-5">
                            ...
                            <div>
                                ...
                                <div class="file-upload-zone" id="file-upload-zone">
                                    ...
                                    <div class="text-center pointer-events-none">
                                        <div
                                            class="w-14 h-14 mx-auto bg-[#d90429]/10 rounded-2xl flex items-center justify-center mb-3">
                                            <svg class="w-7 h-7 text-[#d90429]" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                ...
                                <div id="file-name-display"
                                    class="hidden mt-2 flex items-center gap-2 text-sm text-gray-600 bg-gray-50 rounded-lg px-3 py-2">
                            ...
                            <div class="bg-gray-50 rounded-xl p-5 border border-gray-100">
                                <p class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">Registration
                                    Summary</p>
